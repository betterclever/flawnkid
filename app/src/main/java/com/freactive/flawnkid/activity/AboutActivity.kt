...
class AboutActivity : MaterialAboutActivity() {
    ...
    override fun getMaterialAboutList(context: Context): MaterialAboutList {
        ...
        titleCard.addItem(MaterialAboutActionItem.Builder()
                ...
                .build())
        titleCard.addItem(ConvenienceBuilder.createWebsiteActionItem(this, resources.getDrawable(R.drawable.ic_github_dark_24dp), "GitHub", false, Uri.parse("https://github.com/OpenLauncherTeam/flawnkid")))
        ...
        contributorsCard.addItem(MaterialAboutActionItem.Builder()
                ...
                .setOnClickAction(ConvenienceBuilder.createWebsiteOnClickAction(this, Uri.parse("https://github.com/OpenLauncherTeam/flawnkid/graphs/contributors")))
                .build())
